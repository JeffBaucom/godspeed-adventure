PRODUCT_NAME       = Final
SOURCES            = main.c myLib.c newSpritesheet.c street.c skyline.c splash.c text.c instr.c pause.c win.c lose.c gameSong.c shootSFX.c
DKPATH             = /Users/ABUNAI/Documents/devkitARM/bin
CCPATH             = /usr/bin
VBASIM             = /Users/ABUNAI/Documents/Boycott\ Advance
FIND               = find
COPY               = cp -r
